...
Airlock v0.1.4 macOS 安装镜像；`npm install` 本身不会静默下载、启动应用或修改系统设置。
...
operating system and CPU, and contains a SHA-256-verified Airlock v0.1.4 macOS
...
```text
SHA-256 5c2d1e7b67462703feeca0c6b4eed9a021cad49990b5e267b954a01011b916f3
```
