...
Airlock v0.1.6 安装器（macOS DMG、Windows NSIS、Linux AppImage）；`npm install` 本身不会静默下载、启动应用或修改系统设置。
...
[安装说明](https://github.com/LouisonH/airlock-relay/blob/v0.1.6/docs/installation.zh-CN.md)。
...
operating system and CPU, and contains a SHA-256-verified Airlock v0.1.6 macOS
...
[installation guide](https://github.com/LouisonH/airlock-relay/blob/v0.1.6/docs/installation.md)
before first launch.
...
x64/arm64 are released previews in v0.1.6; Linux ARMv7 remains Core/CLI-only.
