...
Airlock v0.1.5 macOS 安装镜像；`npm install` 本身不会静默下载、启动应用或修改系统设置。
...
[安装与 Gatekeeper 说明](https://github.com/LouisonH/airlock-relay/blob/v0.1.5/docs/installation.zh-CN.md)。
...
operating system and CPU, and contains a SHA-256-verified Airlock v0.1.5 macOS
...
[installation and Gatekeeper guide](https://github.com/LouisonH/airlock-relay/blob/v0.1.5/docs/installation.md)
before first launch.
...
contract for build tooling. Only macOS arm64 is marked as released in v0.1.5.
Windows and Linux CI previews never resolve to an installer until a public
artifact and checksum are published.

## Integrity

Bundled asset: `Airlock_0.1.5_aarch64.dmg`
