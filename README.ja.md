<div align="center">
  ...
  <p>
    <a href="https://github.com/LouisonH/airlock-relay/releases/tag/v0.1.0"><img src="https://img.shields.io/badge/release-v0.1.0%20technical%20preview-b26b25" alt="v0.1.0 テクニカルプレビュー" /></a>
...
> [!WARNING]
> Airlock v0.1.0 はテクニカルプレビューです。ルートメタデータ、認証情報、プロキシ設定は保護ストアに保存されますが、独立した本番セキュリティ監査はまだ完了していません。
