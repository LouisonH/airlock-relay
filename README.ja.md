<div align="center">
  ...
  <p>
    <a href="https://github.com/LouisonH/airlock-relay/releases/tag/v0.1.1"><img src="https://img.shields.io/badge/release-v0.1.1%20technical%20preview-b26b25" alt="v0.1.1 テクニカルプレビュー" /></a>
...
> [!WARNING]
> Airlock v0.1.1 はテクニカルプレビューです。ルートメタデータ、認証情報、プロキシ設定は保護ストアに保存されますが、独立した本番セキュリティ監査はまだ完了していません。
...
必要環境：Go 1.24+、Node.js 20+、Rust/Cargo、Tauri 2 プラットフォーム依存関係。
