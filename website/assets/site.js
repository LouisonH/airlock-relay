const translations = {
  zh: {
    ...
    copied: "已复制命令",
    p0Label: "当前版本",
    p0Notice: "v0.1.3 技术预览版：尚未完成独立生产安全审计。",
  ...
  en: {
    ...
    p0Notice: "v0.1.3 technical preview: no independent production security audit has been completed.",
    architectureEyebrow: "ARCHITECTURE",
    ...
    footerSecurity: "v0.1.3 technical preview · not notarized · no independent production security audit"
  }
};
