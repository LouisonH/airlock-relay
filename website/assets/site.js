const translations = {
  zh: {
    ...
    copied: "已复制命令",
    p0Label: "当前版本",
    p0Notice: "v0.1.6 已于 2026-08-02 发布；维护者生产就绪安全审计已完成。",
    releaseEyebrow: "RELEASE & ASSURANCE",
    releaseTitle: "v0.1.6 已发布，生产就绪审计已完成",
    releaseIntro: "2026 年 7 月 31 日发布。审计涵盖核心转发边界、依赖、发布工件、安装器和公开站点。",
    releasePackageLabel: "公开分发",
    releasePackageTitle: "GitHub Release + npm",
    releasePackageDetail: "已发布 Apple Silicon macOS 工件、SHA-256 清单与 airlock-relay@0.1.6。",
    ...
    releaseReadNotes: "查看 v0.1.6 发布说明",
  ...
  en: {
    ...
    p0Notice: "v0.1.6 released on 2026-08-02; maintainer production-readiness audit completed.",
    releaseEyebrow: "RELEASE & ASSURANCE",
    releaseTitle: "v0.1.6 is released and the production-readiness audit is complete",
    ...
    releasePackageTitle: "GitHub Release + npm",
    releasePackageDetail: "Apple Silicon macOS artifacts, their SHA-256 manifest, and airlock-relay@0.1.6 are published.",
    ...
    releaseReadNotes: "Read v0.1.6 release notes",
    platformEyebrow: "PLATFORM CONTRACT",
    ...
    footerSecurity: "v0.1.6 · maintainer production-readiness audit complete · not third-party certified or notarized"
  }
};
