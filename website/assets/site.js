const translations = {
  zh: {
    ...
    faqSixAnswer: "下载 SHA256SUMS-v0.1.6.txt 后用 shasum -a 256 -c 核对；Linux 产物还可导入 Airlock-gpg-pubkey.asc 后用 gpg --verify 校验签名。安装器本身也会在安装前强制校验。",
  ...
  en: {
    ...
    faqSixAnswer: "Download SHA256SUMS-v0.1.6.txt and run shasum -a 256 -c; for Linux, import Airlock-gpg-pubkey.asc and verify with gpg --verify. The installer also enforces verification before installing.",
    closingEyebrow: "AIRLOCK v0.1.6",
