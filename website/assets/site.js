const translations = {
  zh: {
    ...
    copied: "已复制命令",
    p0Label: "当前版本",
    p0Notice: "v0.1.4 技术预览版：已完成维护者生产就绪安全审计。",
    ...
    footerSecurity: "v0.1.4 技术预览版 · 内部审计完成 · 未公证"
  },
  en: {
    ...
    p0Notice: "v0.1.4 technical preview: maintainer production-readiness audit completed.",
    architectureEyebrow: "ARCHITECTURE",
    ...
    footerSecurity: "v0.1.4 technical preview · maintainer audit complete · not notarized"
  }
};
