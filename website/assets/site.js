const translations = {
  zh: {
    ...
    copied: "已复制命令",
    p0Label: "当前版本",
    p0Notice: "v0.1.5 已于 2026-08-01 发布；维护者生产就绪安全审计已完成。",
    releaseEyebrow: "RELEASE & ASSURANCE",
    releaseTitle: "v0.1.5 已发布，生产就绪审计已完成",
    releaseIntro: "2026 年 7 月 31 日发布。审计涵盖核心转发边界、依赖、发布工件、安装器和公开站点。",
    releasePackageLabel: "公开分发",
    releasePackageTitle: "GitHub Release + npm",
    releasePackageDetail: "已发布 Apple Silicon macOS 工件、SHA-256 清单与 airlock-relay@0.1.5。",
    ...
    releaseReadNotes: "查看 v0.1.5 发布说明",
    ...
    platformMacLabel: "RELEASED PREVIEW",
    platformMacTitle: "macOS / Apple Silicon",
    platformMacDetail: "已发布 DMG 与校验和。使用状态检查后，可显式执行 airlock-installer install --open。",
    platformWindowsLabel: "CI PREVIEW",
    platformWindowsTitle: "Windows / x64 · x86 · ARM64",
    platformWindowsDetail: "npm 可识别平台并安全返回状态；CI 构建产物尚未作为校验后的公开安装包发布。",
    platformLinuxLabel: "CI PREVIEW",
    platformLinuxTitle: "Linux / x64 · ARM64",
    platformLinuxDetail: "CLI/Core 有跨架构构建基线；npm 不下载 CI 工件，也不会在未发布目标上执行安装。",
  ...
  en: {
    ...
    p0Notice: "v0.1.5 released on 2026-08-01; maintainer production-readiness audit completed.",
    releaseEyebrow: "RELEASE & ASSURANCE",
    releaseTitle: "v0.1.5 is released and the production-readiness audit is complete",
    ...
    releasePackageTitle: "GitHub Release + npm",
    releasePackageDetail: "Apple Silicon macOS artifacts, their SHA-256 manifest, and airlock-relay@0.1.5 are published.",
    ...
    releaseReadNotes: "Read v0.1.5 release notes",
    platformEyebrow: "PLATFORM CONTRACT",
    ...
    platformMacLabel: "RELEASED PREVIEW",
    platformMacTitle: "macOS / Apple Silicon",
    platformMacDetail: "A DMG and checksum are published. After the status check, explicitly run airlock-installer install --open.",
    platformWindowsLabel: "CI PREVIEW",
    platformWindowsTitle: "Windows / x64 · x86 · ARM64",
    platformWindowsDetail: "npm recognizes the platform and returns a safe status. CI-built artifacts are not yet published as verified public installers.",
    platformLinuxLabel: "CI PREVIEW",
    platformLinuxTitle: "Linux / x64 · ARM64",
    platformLinuxDetail: "The CLI/Core has cross-architecture build baselines. npm neither downloads CI artifacts nor installs an unreleased target.",
    ...
    footerSecurity: "v0.1.5 · maintainer production-readiness audit complete · not third-party certified or notarized"
  }
};
