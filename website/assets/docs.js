...
const copy = {
  zh: { title: "Airlock 文档", home: "主页", backHome: "返回项目主页", chapters: "章节", chapterCore: "核心概念", chapterDesktop: "桌面控制台", chapterOperate: "发布与运维", searchLabel: "搜索文档", searchPlaceholder: "搜索章节、命令或主题", searchClear: "清除搜索", searchEmpty: "没有找到匹配章节", sections: { boundary: "安全边界", desktop: "路由与活动", version: "版本与更新", cli: "安装 CLI", server: "Server Core", platform: "多平台状态" } },
  en: { title: "Airlock Documentation", home: "Home", backHome: "Back to project home", chapters: "Chapters", chapterCore: "Core concepts", chapterDesktop: "Desktop console", chapterOperate: "Release and operations", searchLabel: "Search documentation", searchPlaceholder: "Search chapters, commands, or topics", searchClear: "Clear search", searchEmpty: "No matching chapters", sections: { boundary: "Security boundary", desktop: "Routes and activity", version: "Versions and updates", cli: "Installer CLI", server: "Server Core", platform: "Platform status" } },
  ja: { title: "Airlock ドキュメント", home: "ホーム", backHome: "プロジェクトホームへ戻る", chapters: "チャプター", chapterCore: "基本概念", chapterDesktop: "デスクトップコンソール", chapterOperate: "リリースと運用", searchLabel: "ドキュメントを検索", searchPlaceholder: "章、コマンド、トピックを検索", searchClear: "検索をクリア", searchEmpty: "一致する章はありません", sections: { boundary: "セキュリティ境界", desktop: "ルートとアクティビティ", version: "バージョンと更新", cli: "インストーラー CLI", server: "Server Core", platform: "プラットフォーム状況" } },
};
