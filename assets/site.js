const translations = {
  zh: {
    ...
    copied: "已复制命令",
    p0Label: "当前状态",
    p0Notice: "P0 技术验证版：在完成发布安全审查前，请勿存放高价值生产凭据。",
  ...
  en: {
    ...
    sshFeatureTwo: "Exact command or high-risk unrestricted exec",
    ...
    p0Label: "Current status",
    p0Notice: "P0 technical preview: do not store high-value production credentials until the release security review is complete.",
    architectureEyebrow: "ARCHITECTURE",
    ...
    footerSecurity: "P0 technical preview; release security review is not yet complete."
  }
};
