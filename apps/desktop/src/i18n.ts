...
const translations: Record<string, Record<Exclude<AppLocale, "zh-CN">, string>> = {
  ...
  "正在启动本地核心": { en: "Starting local core", ja: "ローカルコアを起動中" },
  "正在重启本地核心": { en: "Restarting local core", ja: "ローカルコアを再起動中" },
  "重试本地核心": { en: "Retry local core", ja: "ローカルコアを再試行" },
  "本地核心已启动": { en: "Local core started", ja: "ローカルコアを起動しました" },
  "无法读取本地核心状态，请重试": { en: "Could not read local-core status. Please retry.", ja: "ローカルコアの状態を読み取れません。再試行してください。" },
  "本地核心未能启动：127.0.0.1:4768 或 127.0.0.1:4770 已被其他程序占用。请退出其他 Airlock 副本或释放该端口后重试。": { en: "The local core could not start because another program is using 127.0.0.1:4768 or 127.0.0.1:4770. Quit other Airlock copies or free the ports, then retry.", ja: "別のプログラムが 127.0.0.1:4768 または 127.0.0.1:4770 を使用しているため、ローカルコアを起動できません。他の Airlock を終了するかポートを解放してから再試行してください。" },
  "本地核心未能启动：当前用户的受保护控制通道不可用。请退出其他 Airlock 副本后重试。": { en: "The local core could not start because this user's protected control channel is unavailable. Quit other Airlock copies, then retry.", ja: "現在のユーザーの保護された制御チャネルが利用できないため、ローカルコアを起動できません。他の Airlock を終了してから再試行してください。" },
  "本地核心未能在 4 秒内准备就绪。请重试；若问题持续，请退出其他 Airlock 副本并检查端口 4768 与 4770。": { en: "The local core was not ready within 4 seconds. Retry; if this persists, quit other Airlock copies and check ports 4768 and 4770.", ja: "ローカルコアは 4 秒以内に準備できませんでした。再試行し、問題が続く場合は他の Airlock を終了してポート 4768 と 4770 を確認してください。" },
