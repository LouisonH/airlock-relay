<div align="center">
  ...
  <p>
    <a href="https://github.com/LouisonH/airlock-relay/releases/tag/v0.1.2"><img src="https://img.shields.io/badge/release-v0.1.2%20technical%20preview-b26b25" alt="v0.1.2 technical preview" /></a>
...
> [!WARNING]
> Airlock v0.1.2 is a technical preview. Route metadata, credentials, and proxy configuration use protected storage, but this release has not completed an independent production security audit.
...
The v0.1.2 download supports Apple Silicon Macs running macOS 12 or newer. Install
...
Alternatively, get the DMG and checksum from [GitHub Releases](https://github.com/LouisonH/airlock-relay/releases/tag/v0.1.2),
